...
template <size_t N>
vecn<float, N> sequentialGridSearch(function<float(const vecn<float, N> &)> f,
                                    const vecn<float, N> &x,
                                    const vecn<int, N> &xSteps,
                                    const vecn<float, N> &xDeltas,
...
template <size_t N>
vecn<float, N>
gridSearch(function<float(const vecn<float, N> &)> f, const vecn<float, N> &x,
           int radius, const vecn<float, N> &xDeltas,
...
template <size_t N>
vecn<float, N>
starSearch(function<float(const vecn<float, N> &)> f, const vecn<float, N> &x,
           int radius, const vecn<float, N> &xDeltas,
           bool checkAllPoints = true, bool progressiveSteps = false) {
  float min = f(x);
  auto xMin = x;
...
template <size_t N>
vecn<float, N> ballSearch(function<float(const vecn<float, N> &)> f,
                          const vecn<float, N> &x, float radius, size_t count,
                          bool checkAllPoints = true) {
...
template <size_t N>
vector<vecn<float, N>>
gradientDescent(function<float(const vecn<float, N> &)> f,
                const vecn<float, N> &xStart, int radius,
                const vecn<float, N> &deltas) {
