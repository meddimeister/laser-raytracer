...
% SETUP OF LSSPUB
\lsstitle{Optimization of mirror shapes in optically pumped solar lasers using ray tracing simulation techniques}%
...
An exemplary setup of a side pumped Nd:YAG solar laser was simulated, optimized and the resulting
...
\begin{document}
    ...
    \subsubsection{Optimality and Clarke's Calculus for non-smooth Optimization} 
