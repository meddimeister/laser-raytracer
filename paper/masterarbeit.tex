...
\begin{document}
    ...
    The Lens2D class represents the approximation of a thin lens
    ...
    \todo{OPTIONAL: implement abcd lenses and maybe fresnel lens, dispersion!!!}
    ...
    \todo{optimize $\alpha$ evaluation}
    \todo{split crystal class to medium, grid and crystal class}    
